...
/* ==========================================================================
 * Fixed-length UART protocol, FULLY DMA-based reception using idle-line
 ...
 *
 * Wire format, Pi -> STM32 (command), 10 bytes:
 *   [ START ][ motor1..motor6 ][ cam_tilt_dc ][ CHECKSUM ]
 *      1 B        6x 1 B         2 B (i16)       1 B
 *
 * Wire format, STM32 -> Pi (telemetry), 18 bytes:
 ...
 * No range clamping is done in this protocol layer -- the motor and
 * tilt control functions clamp their own inputs.
 ...
 *
 * All multi-byte values little-endian. All values scaled x10 ("deci-units").
